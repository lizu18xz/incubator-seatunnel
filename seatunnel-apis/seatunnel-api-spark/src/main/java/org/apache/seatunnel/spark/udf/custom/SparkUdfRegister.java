...
package org.apache.seatunnel.spark.udf.custom;
...
public class SparkUdfRegister {

    private static final Logger LOGGER = LoggerFactory.getLogger(SparkUdfRegister.class);

    private SparkSession sparkSession;

    public SparkUdfRegister(SparkSession sparkSession) {
